...
if trainNewModel && checkpointing
    checkpointModelPath=strcat(basepath,'/trained_model/checkpoint/','/faster_rcnn_stage_4_checkpoint__10026__2018_04_29__04_02_13.mat');
end
if ~trainNewModel
    savedModelPath=strcat(savedBasepath,'/model_vgg16_5epoch_600dim');
end
valPercent=0;
%-------------------------------------------------------------------------
